...
DimQ<L_0 + L_1, M_0 + M_1, T_0 + T_1, I_0 + I_1, K_0 + K_1, N_0 + N_1, C_0 + C_1> operator*(const DimQ<L_0, M_0, T_0, I_0, K_0, N_0, C_0> &a, const DimQ<L_1, M_1,T_1, I_1, K_1, N_1, C_1> &b) { return DimQ<L_0 + L_1, M_0 + M_1, T_0 + T_1, I_0 + I_1, K_0 + K_1, N_0 + N_1, C_0 + C_1>(a.get() + b.get()); };
template<int L_0, int M_0, int T_0, int I_0, int K_0, int N_0, int C_0, int L_1, int M_1, int T_1, int I_1, int K_1, int N_1, int C_1>
DimQ<L_0 - L_1, M_0 - M_1, T_0 - T_1, I_0 - I_1, K_0 - K_1, N_0 - N_1, C_0 - C_1> operator/(const DimQ<L_0, M_0, T_0, I_0, K_0, N_0, C_0> &a, const DimQ<L_1, M_1, T_1, I_1, K_1, N_1, C_1> &b) { return DimQ<L_0 - L_1, M_0 - M_1, T_0 - T_1, I_0 - I_1, K_0 - K_1, N_0 - N_1, C_0 - C_1>(a.get() / b.get()); };
...
std::ostream &operator<<(std::ostream &stream, const DimQ< L, M, T, I, K, N, C> &a) {
	std::cout << a.get() << "m^(" << L << ")" << "kg^(" << M << ")" << "s^(" << T << ")" << "A^(" << I << ")" << "K^(" << K << ")" << "M^(" << M << ")" << "C^(" << C << ")" << std::endl;
	return stream;
}
